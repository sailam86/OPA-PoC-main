import { getDevServerLocation } from './getDevServerLocation'; // We need to teak Webpack's public path, especially for Android, where `localhost`
...
const {
  hostname
} = getDevServerLocation(); // eslint-disable-next-line
